...
import franzli347.project.core.netty.helper.AsyncHttpHelper;
...
public class NettyHttpClient implements LifeCycle{
    ...
    public void init() {
        ...
        DefaultAsyncHttpClientConfig.Builder builder = new DefaultAsyncHttpClientConfig.Builder()
                ...
                .setConnectTimeout(Duration.ofMillis(config.getHttpConnectTimeout())) // 连接超时设置
                .setRequestTimeout(Duration.ofMillis(config.getHttpRequestTimeout())) // 请求超时设置
                ...
                .setPooledConnectionIdleTimeout(Duration.ofMillis(config.getHttpPooledConnectionIdleTimeout())); // 连接池中空闲连接的超时时间
        // 根据配置创建异步HTTP客户端
